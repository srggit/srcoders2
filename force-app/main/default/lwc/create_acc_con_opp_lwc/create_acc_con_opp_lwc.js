...
export default class Create_acc_con_opp_lwc extends LightningElement {
    ...
    handleSave(event){
        ...
        .then( response => {
            ...
            this.handleAlertClick('Acc Con Opp Created Successfully !!', 'success', 'success');
        ...
        .catch( error => {
            ...
            /* Error Message Format: If we are not throwing error from Apex
            error = {
                "status": 500,
                "body": {
                    "fieldErrors": {},
            ...
            */
            ...
            // Catch the Error if error is handled/thrown from Apex Class 
            let errString = error.body.message;
            console.log(`errString from Apex : ${errString}`);

            this.handleAlertClick(errString, 'error', 'Error');
        });
    ...
    handleCancel(event){
        history.back();
        /*
        window.location.href = '/lightning/o/Contact/home'; // Redirect to the Account home page
        window.open('/lightning/o/Account/home', '_blank'); // Opens the Account home page in a new tab
        window.location.replace('/lightning/o/Account/home'); // Redirect without saving the current page in history
    ...
    // Toast message don't work when we are calling LWC Component from VF.
    ...
    // Navigation don't work when we are calling LWC Component from  VF.
